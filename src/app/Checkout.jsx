    ...
    return (
        <div className="container mx-auto mt-0">
            {step === 1 && (
              ...
              <TopHeader />
              <MainHeader />
                <div className='w-[100%] lg:w-[70%] flex flex-col items-center justify-start mx-auto border'>
                    ...
                    {cart.length === 0 ? (
                          <p className="text-center">Your cart is empty.</p>
                            ...
                            <div className="w-[90%] lg:w-[60%] flex flex-col items-start justify-start">
                                {cart.map((item) => (
                                    <div key={item._id} className="w-full border p-4 mb-2 flex">
                                        <img
                                        ...
                                        <div className="inline-block">
                                            ...
                                            <input
                                                ...
                                                className="w-[50%] border p-1 mr-2"
                                                defaultValue={1}
                                            />
                                            <button onClick={() => removeFromCart(item._id)} className="bg-red-500 text-white p-1 rounded">
                                                Remove
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <button onClick={handleNext} className="bg-green-500 text-white p-2 mt-4 rounded">
                                    Checkout
                                </button>
                            </div>
                        )}
            ...
            {step === 3 && (
              ...
              <TopHeader />
              <MainHeader />
                <div className="w-[90%] grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
                    ...
                    <div>
                        ...
                        onChange={(e) => {
                            ...
                            console.log("streetAddress value:", e.target.value);
                        }}
                        required
                        />
                    ...
                    <div className="border p-4">
                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="py-2 text-right">Free shipping</td>
                                </tr>
                                <tr>
                        ...
                        <button onClick={handlePlaceOrder} className="bg-blue-500 text-white p-2 mt-4 rounded w-full">
                            Place Order
                        </button>
